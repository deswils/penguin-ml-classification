...
**Palmer Penguins** — 344 penguin records across 3 species (Adelie, Chinstrap, Gentoo) from islands in the Palmer Archipelago, Antarctica.
...
```r
tidyverse, e1071, rpart
```

## How to Run

1. Place `penguins.csv` in the project root directory
2. Create a `figures/` subdirectory — all plots are saved there automatically
3. Run each script independently in RStudio or via `Rscript`
