...
![Elbow Method — Normalized](figures/elbow_normalized.png)
![K-Means Clusters — Normalized](figures/kmeans_normalized.png)
...
![Decision Tree — Deep](figures/tree_model1.png)
![Decision Tree — Pruned](figures/tree_model2.png)
